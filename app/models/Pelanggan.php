...
class Pelanggan extends Model
{
      ...
      public function store()
      {
           if (isset($_POST['btn_simpan'])) {
                  ...
                  $sql = "INSERT INTO tb_pelanggan SET pel_no=:pel_no, pel_nama=:pel_nama, pel_alamat=:pel_alamat, pel_hp=:pel_hp, pel_ktp=:pel_ktp,
      ...
      public function update()
      {
           if (isset($_POST['btn_update'])) {
                  ...
                  $sql = "UPDATE tb_pelanggan
                        SET pel_no=:pel_no, pel_nama=:pel_nama, pel_alamat=:pel_alamat, pel_hp=:pel_hp, pel_ktp=:pel_ktp,
                        pel_seri=:pel_seri, pel_meteran=:pel_meteran, pel_aktif=:pel_aktif
                        WHERE pel_id=:pel_id";
                  $stmt = $this->db->prepare($sql);
                  $stmt->bindParam(":pel_no", $no);
